...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221101_rainydays_ea7b93b5e58c5e022634_20221101113109_archive.zip';
        const ARCHIVE_SIZE       = '57875828';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'ea7b93b-01113109';
        const SECONDARY_PACKAGE_HASH = '56cd8b4-01113109';
        const VERSION            = '1.5.0';
